        ...
        <div class="content-container">
            ...
            <div class="sidebar-left">
                <div class="article-meta">
                    <div class="meta-info">
                        <span class="article-date">{{ \Carbon\Carbon::parse($publication->published_date)->format('F Y') }}</span>
                        ...
                        <img src="{{ $publication->image_path ? Storage::url($publication->image_path) : asset('images/media/image5.png') }}" alt="Author" class="image-left" />
