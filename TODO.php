...
1. Cms name ganti jadi MCI CMS ->done
2. Footer untuk ojk ->done
3. Head untuk form di home Mais ngikut ->done
4. Form for investor samain dengan investor page ->done
5. Image headline bisa di click ->done
6. Platform ecosystem driven paragraph di dekatiin ->done
7. About program di exponent, testimonial jadi 5 ->done
