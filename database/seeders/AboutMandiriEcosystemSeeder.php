...
class AboutMandiriEcosystemSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $datas = [
            [
                'title' => 'The Biggest Conglomerate with Various Subsidiaries.',
                'slug' => 'bank-mandiri',
                'content' => "Mandiri’s total asset amount to Rp. 2.427 Tn a of Q4 2024, Mandiri has 42+ Mn retail customers and 200k+ SMEs, 137 Branch offices, 12k+ ATM, 7 overseas branch offices which includes Singapore, Hong Kong, Shanghai, Cayman Islands, Dili, London, and Malaysia.",
