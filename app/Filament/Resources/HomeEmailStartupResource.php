...
use App\Filament\Resources\HomeEmailStartupResource\Pages;
...
class HomeEmailStartupResource extends Resource
{
    protected static ?string $model = HomeEmailStartup::class;

    protected static ?string $navigationIcon = 'heroicon-o-photo';

    protected static ?string $navigationGroup = 'Home Management';

    protected static ?string $navigationLabel = 'Email Form Startup';
    ...
    {
        return [
            'index' => Pages\ListHomeEmailStartup::route('/'),
            'create' => Pages\CreateHomeEmailStartup::route('/create'),
            'edit' => Pages\EditHomeEmailStartup::route('/{record}/edit'),
        ];
    }
}
